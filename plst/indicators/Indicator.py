...
class Indicator:
    ...
    def get_st_calculator_connection(self):
        return self.__db

    def get_st_connection(self):
        return self.__db

    def get__st_user(self):
        return self.__db_user

    def get__st_host(self):
        return self.__db_host

    def get__st_port(self):
        return self.__db_port

    def get__st_passw(self):
        return self.__db_passw

    def get__st_dbname(self):
